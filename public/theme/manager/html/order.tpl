...
{capture name='page_scripts'}
    ...
    <script type="text/javascript" src="theme/{$settings->theme|escape}/js/apps/order.js?v=1.18"></script>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <form action="{url}" class="js-order-item-form " id="fio_form">
                                            ...
                                            <div class="edit-block hide">
                                                ...
                                                <div class="form-group mb-1">
                                                    <input type="text" name="firstname" value="{$order->firstname|escape}" class="form-control" placeholder="Имя" />
                                                </div>
                                                <div class="form-group mb-1">
                                                    <input type="text" name="patronymic" value="{$order->patronymic|escape}" class="form-control" placeholder="Отчество" />
                                                </div>
                                                <div class="form-group mb-1">
                                                    <input type="text" name="phone_mobile" value="{$order->phone_mobile|escape}" class="form-control" placeholder="Телефон" />
                                                </div>
                                        ...
                                        <div class="js-order-status">
                                            ...
                                            <form class=" pt-1 js-confirm-contract">
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" name="phone" class="js-contract-phone" value="{$order->phone_mobile|escape}" />
                                                    ...
                                                    <div class="row pt-2 view-block {if $contactdata_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group row m-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">{$order->passport_serial|escape} {$order->subdivision_code|escape}, от {$order->passport_date|escape}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group row m-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <ul class="list-unstyled form-control-static pl-0">
                                                                        {if $order->social}
                                                                        <li>
                                                                            <a target="_blank" href="{$order->social|escape}">{$order->social|escape}</a>
                                                                        </li>
                                                                        {/if}
                                                                    </ul>
                                                                </div>
                                                    ...
                                                    <div class="row p-2 edit-block {if !$contactdata_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 {if in_array('empty_email', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" name="email" value="{$order->email|escape}" class="form-control" placeholder="" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 {if in_array('empty_birth', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" name="birth" value="{$order->birth|escape}" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="social" value="{$order->social|escape}" placeholder="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 {if in_array('empty_passport_serial', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_serial" value="{$order->passport_serial|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 {if in_array('empty_passport_date', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_date" value="{$order->passport_date|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 {if in_array('empty_subdivision_code', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="subdivision_code" value="{$order->subdivision_code|escape}" placeholder="" required="true" />
                                                    ...
                                                    <div class="row view-block m-0 {if $contacts_error}hide{/if}">
                                                        <table class="table table-hover mb-0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="js-mango-call mango-call js-event-add-click" data-phone="{$order->contact_person_phone|escape}" title="Выполнить звонок" data-event="61" data-manager="{$manager->id}" data-order="{$order->order_id}" data-user="{$order->user_id}">
                                                                        <i class="fas fa-mobile-alt"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div class="row m-0 pt-2 pb-2 edit-block {if !$contacts_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person_name', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_name" value="{$order->contact_person_name|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person_phone', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_phone" value="{$order->contact_person_phone|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person2_name', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_name" value="{$order->contact_person2_name|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person2_phone', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_phone" value="{$order->contact_person2_phone|escape}" placeholder="" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-hover mb-0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {if $order->Regindex}{$order->Regindex|escape}, {/if}
                                                                        {$order->Regregion} {$order->Regregion_shorttype|escape},
                                                                        {if $order->Regcity}{$order->Regcity|escape} {$order->Regcity_shorttype|escape},{/if}
                                                                        {if $order->Regdistrict}{$order->Regdistrict|escape} {$order->Regdistrict_shorttype|escape},{/if}
                                                                        {if $order->Reglocality}{$order->Reglocality_shorttype|escape} {$order->Reglocality|escape},{/if}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {if $order->Faktindex}{$order->Faktindex|escape}, {/if}
                                                                        {$order->Faktregion} {$order->Faktregion_shorttype|escape},
                                                                        {if $order->Faktcity}{$order->Faktcity|escape} {$order->Faktcity_shorttype|escape},{/if}
                                                                        {if $order->Faktdistrict}{$order->Faktdistrict|escape} {$order->Faktdistrict_shorttype|escape},{/if}
                                                                        {if $order->Faktlocality}{$order->Faktlocality_shorttype|escape} {$order->Faktlocality|escape},{/if}
                                                                        {if $order->Faktstreet}{$order->Faktstreet|escape} {$order->Faktstreet_shorttype|escape},{/if}
                                                                        д.{$order->Fakthousing|escape},
                                                                        {if $order->Faktbuilding}стр. {$order->Faktbuilding|escape},{/if}
                                                                        {if $order->Faktroom}кв.{$order->Faktroom|escape}{/if}
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        ...
                                                        <div class="row m-0 mb-2 mt-2 js-dadata-address">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regregion', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-region" name="Regregion" value="{$order->Regregion|escape}" placeholder="" required="true" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-region-type" name="Regregion_shorttype" value="{$order->Regregion_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regcity', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-city" name="Regcity" value="{$order->Regcity|escape}" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-city-type" name="Regcity_shorttype" value="{$order->Regcity_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-district" name="Regdistrict" value="{$order->Regdistrict|escape}" placeholder=""/>
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-district-type" name="Regdistrict_shorttype" value="{$order->Regdistrict_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-locality" name="Reglocality" value="{$order->Reglocality|escape}" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-locality-type" name="Reglocality_shorttype" value="{$order->Reglocality_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regstreet', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-street" name="Regstreet" value="{$order->Regstreet|escape}" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-street-type" name="Regstreet_shorttype" value="{$order->Regstreet_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group {if in_array('empty_reghousing', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-house" name="Reghousing" value="{$order->Reghousing|escape}" placeholder="" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-building" name="Regbuilding" value="{$order->Regbuilding|escape}" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row m-0 js-dadata-address">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_faktregion', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-region" name="Faktregion" value="{$order->Faktregion|escape}" placeholder="" required="true" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-region-type" name="Faktregion_shorttype" value="{$order->Faktregion_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_faktcity', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-city" name="Faktcity" value="{$order->Faktcity|escape}" placeholder=""  />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-city-type" name="Faktcity_shorttype" value="{$order->Faktcity_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-district" name="Faktdistrict" value="{$order->Faktdistrict|escape}" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-district-type" name="Faktdistrict_shorttype" value="{$order->Faktdistrict_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-locality" name="Faktlocality" value="{$order->Faktlocality|escape}" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-locality-type" name="Faktlocality_shorttype" value="{$order->Faktlocality_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_faktstreet', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-street" name="Faktstreet" value="{$order->Faktstreet|escape}" placeholder=""  />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-street-type" name="Faktstreet_shorttype" value="{$order->Faktstreet_shorttype|escape}" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group {if in_array('empty_fakthousing', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Дом</label>
                                                                    <input type="text" class="form-control js-dadata-house" name="Fakthousing" value="{$order->Fakthousing|escape}" placeholder="" />
                                                    ...
                                                    <div class="row m-0 pt-2 view-block {if $work_error}hide{/if}">
                                                                    ...
                                                                    <p class="form-control-static">
                                                                        <span class="clearfix">
                                                                            ...
                                                                            <span class="float-right">
                                                                                ...
                                                                                <button class="js-mango-call mango-call js-event-add-click" data-event="62" data-manager="{$manager->id}" data-order="{$order->order_id}" data-user="{$order->user_id}" data-phone="{$order->workphone|escape}" title="Выполнить звонок">
                                                                                    <i class="fas fa-mobile-alt"></i>
                                                                                </button>
                                                                            </span>
                                                                        </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group  mb-0 row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">
                                                                        {$order->chief_name|escape}, {$order->chief_position|escape}
                                                                        <br />
                                                                        {$order->chief_phone|escape}
                                                                        <button class="js-mango-call mango-call js-event-add-click" data-event="63" data-manager="{$manager->id}" data-order="{$order->order_id}" data-user="{$order->user_id}" data-phone="{$order->chief_phone|escape}" title="Выполнить звонок">
                                                                            <i class="fas fa-mobile-alt"></i>
                                                                        </button>
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <div class="form-group mb-0 row">
                                                                <label class="control-label col-md-8 col-7">
                                                                    ...
                                                                    <span class="label label-custom">Z</span>
                                                                        ...
                                                                        <small class="text-danger">Страховка возвращена</small>
                                                                        {else}
                                                                        <button class="btn btn-xs btn-danger js-return-insure" data-contract="{$contract->id}" type="button">Вернуть</button>
                                                                        {/if}
                                                                    {/if}
                                                                </label>
                                                                <div class="col-md-4 col-5">
                                            ...
                                            <div class="row p-2 view-block {if $socials_error}hide{/if}">
                                                ...
                                                {foreach $files as $file}
                                                    ...
                                                    <li class="order-image-item ribbon-wrapper rounded-sm border {$item_class}">
                                                        <a class="image-popup-fit-width js-event-add-click"  href="javascript:void(0);" onclick="window.open('{$config->front_url}/files/users/{$file->name}');" data-event="50" data-manager="{$manager->id}" data-order="{$order->order_id}" data-user="{$order->user_id}">
