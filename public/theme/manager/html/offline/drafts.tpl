{$meta_title='Черновики' scope=parent}
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0"><i class="mdi mdi-animation"></i>Черновики</h3>
                <ol class="breadcrumb">
                            ...
                            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                <table class="jsgrid-table table table-striped table-hover">
                                    <tr class="jsgrid-header-row">
                                        <th style="width: 70px;" class="jsgrid-header-cell jsgrid-header-sortable {if $sort == 'order_id_desc'}jsgrid-header-sort jsgrid-header-sort-desc{elseif $sort == 'order_id_asc'}jsgrid-header-sort jsgrid-header-sort-asc{/if}">
                                ...
                                <table class="jsgrid-table table table-striped table-hover" style="text-align: center">
                                    ...
                                    {foreach $orders as $order}
                                        <tr class="jsgrid-row js-order-row {if $manager->role == 'quality_control' && $order->quality_workout}workout-row{/if}">
                                            <td style="width: 70px;" class="jsgrid-cell">
                                                <a href="/neworder/draft/{$order->order_id}">{$order->group_number} {$order->company_number} {$order->personal_number}</a>
