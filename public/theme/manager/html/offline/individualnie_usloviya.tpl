<table>
    ...
    <tr style="width: 100%">
        <br>
        <td style="width: 100%; font-size: 8px;" align="justify">юридический адрес город Москва, улица Ленинская
            Слобода,
            дом 26,
            строение
            28,
...
<div>
    ...
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">При невыполнении или ненадлежащем исполнении обязательств по
