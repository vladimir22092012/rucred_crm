...
<table style="width: 100%; page-break-after: always" border="1" cellpadding="7">
    <tr>
        ...
        <td style="width: 50%">(01) Через работодателя на основании заявления о перечислении части причитающихся
            ...
            средств:<br><br>
            {if $settlement_id == 2}&#x2611;{else}&#10065;{/if} <u>в АО «МИнБанк»</u><br><br>
            ...
            - назначение платежа «Оплата по договору микрозайма № <strong>{$uid} от {$created_date|date}</strong>
            года»<br><br>
            {if $settlement_id == 3}&#x2611;{else}&#10065;{/if} <u>в ПАО «РосДорБанк»</u><br><br>
            - получатель ООО МКК «Русское кредитное общество»<br>
    ...
    <tr>
        <td style="width: 50%"><strong>9.</strong> Дополнительные условия обслуживания микрозайма</td>
    ...
    <tr>
        <td style="width: 50%"><strong>10.</strong> Возможность досрочного полного или частичного погашения микрозайма</td>
...
<table style="width: 100%;" border="1" cellpadding="7">
    <tr>
        <td style="width: 50%"><strong>11.</strong> Штрафы, пени и дополнительные комиссии за нарушение условий обслуживания микрозайма</td>
        <td style="width: 50%">(01) При нарушении графика обслуживания и/или объёмов возможно взыскание неустойки из
            расчёта 0,055% за каждый день просрочки, начиная с восьмого дня, от непогашенной суммы долга, но не более 20%
    ...
    <tr>
        <td style="width: 50%"><strong>12.</strong> Особенности применения условий микрозайма</td>
