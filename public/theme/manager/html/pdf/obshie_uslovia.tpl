...
<table border="1" cellpadding="10">
    ...
    <tr>
        ...
        <td style="60%">На неотложные нужды</td>
    </tr>
    <tr>
...
<table style="width: 100%; page-break-after: always" border="1" cellpadding="7">
    ...
    <tr>
        <td style="width: 50%"><strong>10.</strong> Возможность досрочного полного или частичного погашения микрозайма
        </td>
...
<table style="width: 100%;" border="1" cellpadding="7">
    <tr>
        <td style="width: 50%"><strong>11.</strong> Штрафы, пени и дополнительные комиссии за нарушение условий
            обслуживания микрозайма
        </td>
        <td style="width: 50%">(01) При нарушении графика обслуживания и/или объёмов возможно взыскание неустойки из
            расчёта 0,055% за каждый день просрочки, начиная с восьмого дня, от непогашенной суммы долга, но не более
            20%
...
<table style="color: #fffefd; background-color: #0A0A0A" cellspacing="5">
    <tr>
        <td><h4>При увольнении заёмщика микрозаём может быть истребован из средств<br>при расчёте с работником при
                увольнении</h4></td>
    </tr>
</table>