...
<div>
    Приложение №1 к Дополнительному соглашению от <strong>{$restruct_date|date}</strong> года к Договору микрозайма
    от <strong>{$probably_start_date|date}</strong> года № <strong>{$uid}</strong>
</div>
<hr>
<div></div>
<table border="1">
