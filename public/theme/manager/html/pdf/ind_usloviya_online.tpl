...
<table>
    <tr style="width: 100%">
        ...
        <td style="width: 5%"></td>
        <td style="width: 45%">Приложение №3а
    ...
    <tr style="width: 100%">
        ...
        <td style="width: 100%; font-size: 8px;" align="justify">юридический адрес
            ...
            основным
            государственным регистрационным номером 1217700334532, ИНН 9725055162, КПП 772701001, зарегистрированное в
...
<div align="justify"><br>Общество с ограниченной ответственностью Микрокредитная компания «Русское кредитное общество»,
    ...
    Федерации <strong>{$lastname|upper} {$firstname|upper} {$patronymic|upper} {$birth|date_format:'%d.%m.%Y'}</strong>
    года рождения, место
...
{else}
    <table style="border: 0.25pt solid #002088; width: 50%; font-size: 8px; page-break-after: always;"
        ...
        <tr>
            <td colspan="2"><strong>Дата подписания:</strong> {$code_asp->created|date} {$code_asp->created|time}(МСК)
            </td>
        </tr>
        <tr>
...
{/if}
<div align="justify">действуя добровольно в своих интересах, от своего имени, с другой стороны, далее совместно
    именуемые «Стороны», на
    ...
    настоящий Договор микрозайма (далее – «Договор») на следующих Индивидуальных условиях.
</div>
<br><br><br>
...
<table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
    ...
    <tr style="width: 100%;">
        ...
        <td style="width: 70%">1217700334532</td>
    </tr>
    <tr style="width: 100%;">
    ...
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">Количество ежемесячных
                платежей:
                <strong>{count($payment_schedule) - 1}</strong><br>Размер
...
{else}
    <table style="border: 0.25pt solid #002088; width: 50%; font-size: 7px; page-break-after: always;" cellspacing="2">
        <tr>
            <td colspan="2"><strong>ДОКУМЕНТ ПОДПИСАН ЭЛЕКТРОННОЙ ЦИФРОВОЙ ПОДПИСЬЮ</strong></td>
        </tr>
        <tr>
    ...
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">Заёмщик вправе погасить микрозаём досрочно полностью или частично без
                ...
                изменения, которые оформляются новой редакцией в виде Дополнительного соглашения к Договору и графика
                платежей.
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">Погашение микрозайма, уплата процентов за пользование микрозаймом
                ...
                счёт погашения задолженности по Договору микрозайма<br>
                - Оплата в личном кабинете Заёмщика с помощью банковской карты.
            </td>
        </tr>
        <tr style="width: 100%;">
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%">На неотложные нужды
            </td>
        </tr>
    </table>
</div>
...
<div>
    ...
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">С содержанием Общих условий получения и обслуживания микрозайма
                ...
                {if isset($code_asp->code)}
                <table style="border: 0.25pt solid #002088; font-size: 9px; width: 70%"
                       cellpadding="1" cellspacing="2">
                    <tr>
                        <td colspan="2"><strong>ДОКУМЕНТ ПОДПИСАН ЭЛЕКТРОННОЙ ЦИФРОВОЙ ПОДПИСЬЮ</strong></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"><strong>Дата
                                подписания:</strong> {$code_asp->created|date} {$code_asp->created|time}(МСК)
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><strong>ID подписания:</strong> {$code_asp->uid}</td>
                    ...
                    <tr>
                        <td><strong>Система ЭДО:</strong><br>Рестарт.Онлайн</td>
                        <td><img src="{$config->root_url}/theme/manager/html/pdf/i/Vector.png" style="height: 25px">
                        </td>
                    </tr>
                </table>
                {/if}<br><br>Общие
    ...
    {else}
        <table style="border: 0.25pt solid #002088; width: 50%; font-size: 9px; page-break-after: always;"
            ...
            <tr>
                <td colspan="2"><strong>Дата подписания:</strong> {$code_asp->created|date} {$code_asp->created|time}
                    (МСК)
                </td>
            </tr>
            <tr>
    ...
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">Микрозаём предоставляется Заёмщику не
                позднее {$probably_start_date|date} в
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">Заёмщик согласен на предоставление Заимодавцем информации третьим
                лицам в объёме,
                порядке и на условиях, предусмотренных Общими условиями Договора<br><br>
                {if isset($code_asp->code)}
                    <table style="border: 0.25pt solid #002088; font-size: 9px; width: 80%"
                           cellpadding="1" cellspacing="2">
                        <tr>
                            <td colspan="2"><strong>ДОКУМЕНТ ПОДПИСАН ЭЛЕКТРОННОЙ ЦИФРОВОЙ ПОДПИСЬЮ</strong></td>
                        </tr>
...
<div>
    <h3><strong>2. ИНДИВИДУАЛЬНЫЕ УСЛОВИЯ ДОГОВОРА МИКРОЗАЙМА</strong></h3>
    <table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
        <tr style="width: 100%;">
            <td style="width: 30%; background-color: #b3b2ab">Условие</td>
            <td style="width: 70%">Содержание условия</td>
...
<table border="1" style="width: 100%; font-size: 9px" cellpadding="5">
    <tr style="width: 100%;">
        ...
        <td style="width: 70%" align="left">Споры, не урегулированные Договором и иными соглашениями Сторон, подлежат
            ...
            будущем в любое время до принятия дела судом к своему производству рассматриваются в Гагаринском районном
            суде города Москвы по адресу: 119049, город Москва, улица Донская, дом 11, строение 1, по месту нахождения
            Общества
        </td>
    </tr>
</table>
<div>
    <h3><strong>3. ИНФОРМАЦИЯ О ПОЛНОЙ СТОИМОСТИ МИКРОЗАЙМА, РАССЧИТАННОЙ НА ОСНОВАНИИ ГРАФИКА ПЛАТЕЖЕЙ ПО
            МИКРОЗАЙМУ</strong></h3>
        ...
        <tr style="width: 100%;">
            ...
            <td style="width: 70%" align="left">(01) Сумма микрозайма: <strong>{$amount|number_format:0:',':' '}
                ...
                ставка по микрозайму в день: <strong>{$percent|number_format:3:',':' '}%
                    ({$percents_per_day_str_part_one|upper} {if $percents_per_day_str_part_two|upper} ЦЕЛЫХ И {$percents_per_day_str_part_two|upper} ТЫСЯЧНЫХ ПРОЦЕНТА{/if}
                    )</strong><br>(04) Полная
...
{/if}
<h3><strong>5. ЗАВЕРЕНИЯ ЗАЁМЩИКА</strong></h3>
        ...
        {else}
            <td style="width: 45%">
                <table style="border: 0.25pt solid #02a900; font-size: 8px"
                    ...
                    <tr>
                        <td colspan="2"><strong>Подписант:</strong> Генеральный директор<br>ООО МКК "Русское кредитное
                            общество"<br>А.В. Лоскутов
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><strong>Дата
                                подписания:</strong> {$rucred_asp->created|date} {$rucred_asp->created|time}(МСК)
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><img src="{$config->root_url}/theme/manager/html/pdf/i/Mask_group.png" style="height: 22px">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 45%">
                <table style="border: 0.25pt solid #002088; font-size: 8px"
                    ...
                    <tr>
                        <td><strong>Система ЭДО:</strong> Рестарт.Онлайн</td>
                        <td><img src="{$config->root_url}/theme/manager/html/pdf/i/Vector.png" style="height: 27px">
                        </td>
                    </tr>
                </table>
            </td>
