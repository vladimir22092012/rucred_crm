...
<head>
    ...
    <!--alerts CSS -->
    <link href="theme/{$settings->theme|escape}/assets/plugins/sweetalert2/dist/sweetalert2.min.css?v=1.02" rel="stylesheet">
    <!-- Custom CSS -->
                                ...
                                <li>
                                    <div class="dw-user-box">
                                        <div class="u-text">
                                            ...
                                            {if $manager->role == 'developer'}<span class="badge badge-danger">{$manager->role}</span>
                                            {elseif $manager->role == 'admin'}<span class="badge badge-success">{$manager->role}</span>
                                            {elseif $manager->role == 'manager'}<span class="badge badge-primary">{$manager->role}</span>
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="nav-small-cap">Работа с заявками</li>
                    ...
                    <li {if in_array($module, ['MissingController'])}class="active"{/if}>
                        <a class="" href="missing/" aria-expanded="false"><i class="mdi mdi-sleep"></i><span class="hide-menu">Отвалы</span></a>
                    </li>                    
                    ...
                    <li {if $offline}class="active"{/if}>
                        <a class="" href="offline_orders/" aria-expanded="false"><i class="mdi mdi-animation"></i><span class="hide-menu">Заявки</span></a>
                    </li>
                    {/if}

                    {if in_array('offline', $manager->permissions)}
                    <li {if $offline}class="active"{/if}>
                        <a class="" href="wages" aria-expanded="false"><i class="mdi mdi-animation"></i><span class="hide-menu">ЗП</span></a>
                    </li>
                    {/if}

                    {if in_array('offline_settings', $manager->permissions)}
                    <li {if in_array($module, ['OfflineOrganizationsController', 'OfflinePointsController', 'LoantypesController', 'LoantypeController'])}class="active"{/if}>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            {if in_array('offline_settings', $manager->permissions)}
                            <li {if in_array($module, ['OfflinePointsController'])}class="active"{/if}><a href="offline_points">Оффлайн отделения</a></li> 
                            <li {if in_array($module, ['OfflineOrganizationsController'])}class="active"{/if}><a href="offline_organizations">Оффлайн Организации</a></li>
                            <li {if in_array($module, ['LoantypesController','LoantypeController'])}class="active"{/if}><a href="loantypes">Виды кредитования</a></li>
                            {/if}
                        </ul>
                    </li>
                    {/if}
                    ...
                    <li {if in_array($module, ['PageController', 'PagesController'])}class="active"{/if}>
                        <a class="" href="pages" aria-expanded="false"><i class="mdi mdi-application"></i><span class="hide-menu">Страницы сайта</span></a>
                    </li>
                    {/if}
