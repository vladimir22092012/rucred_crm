                                        ...
                                        <div class="border p-2">
                                            <div class="row">
                                                <h3 class="form-control-static col-md-2">
                                                    {if $client->loaded_from_1c}<span class="label label-primary">1С</span>{/if}
                                                    {if $client->have_crm_closed}<span class="label label-primary" title="Клиент уже имеет погашенные займы в CRM">ПК CRM</span>
                                                    {elseif $client->loan_history|count > 0}<span class="label label-success" title="Клиент уже имеет погашенные займы в CRM">ПК</span>
                                                    {elseif $client->orders|count == 1}<span class="badge badge-success">Новый клиент</span>
                                                    {elseif $client->orders|count > 1}<span class="label label-warning">Повтор</span>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                                                        <input type="checkbox" class="custom-control-input js-blocked-input" id="blocked" value="1" data-user="{$client->id}" {if $client->blocked}checked{/if}>
                                                ...
                                                <h3 class="col-md-4 text-right">
                                                    ...
                                                    <button class="js-mango-call mango-call" data-phone="{$client->phone_mobile|escape}" title="Выполнить звонок">
                                                    ...
                                                    <div class="row pt-2 view-block {if $contactdata_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group row m-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">{$client->passport_serial}, от {$client->passport_date|escape} {$client->subdivision_code|escape}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group row m-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <ul class="list-unstyled form-control-static pl-0">
                                                                        {if $client->social}
                                                                        <li>
                                                                            <a target="_blank" href="{$client->social|escape}">{$client->social|escape}</a>
                                                                        </li>
                                                                        {/if}
                                                                    </ul>
                                                                </div>
                                                    ...
                                                    <div class="row p-2 edit-block {if !$contactdata_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 {if in_array('empty_email', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" name="email" value="{$client->email|escape}" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 {if in_array('empty_birth', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" name="birth" value="{$client->birth|escape}" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="social" value="{$client->social|escape}" placeholder="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2 {if in_array('empty_birth_place', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" name="birth_place" value="{$client->birth_place|escape}" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group {if in_array('empty_passport_issued', (array)$contactdata_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_issued" value="{$client->passport_issued|escape}" placeholder="" required="true" />
                                                    ...
                                                    <div class="row view-block m-0 {if $contacts_error}hide{/if}">
                                                        <table class="table table-hover mb-0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="js-mango-call mango-call" data-phone="{$client->contact_person_phone|escape}" title="Выполнить звонок">
                                                                        <i class="fas fa-mobile-alt"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="js-mango-call mango-call" data-phone="{$client->contact_person2_phone|escape}" title="Выполнить звонок">
                                                                        <i class="fas fa-mobile-alt"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div class="row m-0 pt-2 pb-2 edit-block {if !$contacts_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person_name', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_name" value="{$client->contact_person_name|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person_relation', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <select class="form-control custom-select" name="contact_person_relation">
                                                                    <option value="" {if $client->contact_person_relation == ''}selected=""{/if}>Выберите значение</option>
                                                                    <option value="мать/отец" {if $client->contact_person_relation == 'мать/отец'}selected=""{/if}>мать/отец</option>
                                                                    <option value="муж/жена" {if $client->contact_person_relation == 'муж/жена'}selected=""{/if}>муж/жена</option>
                                                                    <option value="сын/дочь" {if $client->contact_person_relation == 'сын/дочь'}selected=""{/if}>сын/дочь</option>
                                                                    <option value="коллега" {if $client->contact_person_relation == 'коллега'}selected=""{/if}>коллега</option>
                                                                    <option value="друг/сосед" {if $client->contact_person_relation == 'друг/сосед'}selected=""{/if}>друг/сосед</option>
                                                                    <option value="иной родственник" {if $client->contact_person_relation == 'иной родственник'}selected=""{/if}>иной родственник</option>
                                                                </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person_phone', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_phone" value="{$client->contact_person_phone|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person2_name', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_name" value="{$client->contact_person2_name|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person2_relation', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <select class="form-control custom-select" name="contact_person2_relation">
                                                                    <option value="" {if $client->contact_person2_relation == ''}selected=""{/if}>Выберите значение</option>
                                                                    <option value="мать/отец" {if $client->contact_person2_relation == 'мать/отец'}selected=""{/if}>мать/отец</option>
                                                                    <option value="муж/жена" {if $client->contact_person2_relation == 'муж/жена'}selected=""{/if}>муж/жена</option>
                                                                    <option value="сын/дочь" {if $client->contact_person2_relation == 'сын/дочь'}selected=""{/if}>сын/дочь</option>
                                                                    <option value="коллега" {if $client->contact_person2_relation == 'коллега'}selected=""{/if}>коллега</option>
                                                                    <option value="друг/сосед" {if $client->contact_person2_relation == 'друг/сосед'}selected=""{/if}>друг/сосед</option>
                                                                    <option value="иной родственник" {if $client->contact_person2_relation == 'иной родственник'}selected=""{/if}>иной родственник</option>
                                                                </select>
                                                                {if in_array('empty_contact_person2_relation', (array)$contacts_error)}<small class="form-control-feedback">Укажите кем приходится контакное лицо!</small>{/if}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group {if in_array('empty_contact_person2_phone', (array)$contacts_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_phone" value="{$client->contact_person2_phone|escape}" placeholder="" />
                                                        ...
                                                        <div class="row m-0 mb-2 mt-2 js-dadata-address">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regregion', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-region" name="Regregion" value="{$client->Regregion|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regcity', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-city" name="Regcity" value="{$client->Regcity|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-district" name="Regdistrict" value="{$client->Regdistrict|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1 ">
                                                                    <label class="control-label">Нас. пункт</label>
                                                                    <input type="text" class="form-control js-dadata-locality" name="Reglocality" value="{$client->Reglocality|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1 {if in_array('empty_regstreet', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Улица</label>
                                                                    <input type="text" class="form-control js-dadata-street" name="Regstreet" value="{$client->Regstreet|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group {if in_array('empty_reghousing', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-house" name="Reghousing" value="{$client->Reghousing|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-building" name="Regbuilding" value="{$client->Regbuilding|escape}" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Квартира</label>
                                                                    <input type="text" class="form-control js-dadata-room" name="Regroom" value="{$client->Regroom|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Индекс</label>
                                                                    <input type="text" class="form-control js-dadata-index" name="Regindex" value="{$client->Regindex|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row m-0 js-dadata-address">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_faktregion', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Область</label>
                                                                    <input type="text" class="form-control js-dadata-region" name="Faktregion" value="{$client->Faktregion|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_faktcity', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Город</label>
                                                                    <input type="text" class="form-control js-dadata-city" name="Faktcity" value="{$client->Faktcity|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1">
                                                                    <label class="control-label">Район</label>
                                                                    <input type="text" class="form-control js-dadata-district" name="Faktdistrict" value="{$client->Faktdistrict|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1">
                                                                    <label class="control-label">Нас. пункт</label>
                                                                    <input type="text" class="form-control js-dadata-locality" name="Faktlocality" value="{$client->Faktlocality|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1 {if in_array('empty_faktstreet', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Улица</label>
                                                                    <input type="text" class="form-control js-dadata-street" name="Faktstreet" value="{$client->Faktstreet|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group {if in_array('empty_fakthousing', (array)$addresses_error)}has-danger{/if}">
                                                                    <label class="control-label">Дом</label>
                                                                    <input type="text" class="form-control js-dadata-house" name="Fakthousing" value="{$client->Fakthousing|escape}" placeholder="" required="true" />
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Строение</label>
                                                                    <input type="text" class="form-control js-dadata-building" name="Faktbuilding" value="{$client->Faktbuilding|escape}" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Квартира</label>
                                                                    <input type="text" class="form-control js-dadata-room" name="Faktroom" value="{$client->Faktroom|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Индекс</label>
                                                                    <input type="text" class="form-control js-dadata-index" name="Faktindex" value="{$client->Faktindex|escape}" placeholder="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row m-0 pt-2 view-block {if $work_error}hide{/if}">
                                                                    ...
                                                                    <p class="form-control-static">
                                                                        <span class="clearfix">
                                                                            ...
                                                                            <span class="float-right">
                                                                                ...
                                                                                <button class="js-mango-call mango-call" data-phone="{$client->workphone|escape}" title="Выполнить звонок">
                                                                                    <i class="fas fa-mobile-alt"></i>
                                                                                </button>
                                                                            </span>
                                                                        </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group  mb-0 row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">
                                                                        {$client->chief_name|escape}, {$client->chief_position|escape}
                                                                        <br />
                                                                        {$client->chief_phone|escape}
                                                                        <button class="js-mango-call mango-call" data-phone="{$client->chief_phone|escape}" title="Выполнить звонок">
                                                                            <i class="fas fa-mobile-alt"></i>
                                                                        </button>
                                                                    </p>
                                                                </div>
                                                    ...
                                                    <div class="row m-0 pt-2 edit-block js-dadata-address {if !$work_error}hide{/if}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0 {if in_array('empty_workplace', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="workplace" value="{$client->workplace|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0 {if in_array('empty_profession', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="profession" value="{$client->profession|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" class="form-control" name="workaddress" value="{$client->workaddress|escape}" placeholder="" required="true" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_workphone', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="workphone" value="{$client->workphone|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_income', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="income" value="{$client->income|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_expenses', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="expenses" value="{$client->expenses|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_chief_name', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_name" value="{$client->chief_name|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_chief_position', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_position" value="{$client->chief_position|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 {if in_array('empty_chief_phone', (array)$work_error)}has-danger{/if}">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_phone" value="{$client->chief_phone|escape}" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 ">
                                                                ...
                                                                <input type="text" class="form-control" name="workcomment" value="{$client->workcomment|escape}" placeholder="" />
                                                            </div>
                                                        </div>
                                                ...
                                                <form action="{url}" class="mb-3 border js-order-item-form" id="services_form">
                                                    ...
                                                    <div class="row p-2 edit-block {if !$services_error}hide{/if}">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox" class="custom-control-input" name="service_reason" id="service_reason" value="1" {if $client->service_reason}checked="true"{/if} />
                                                                    <label class="custom-control-label" for="service_reason">Причина отказа</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox" class="custom-control-input" name="service_insurance" id="service_insurance" value="1" {if $client->service_insurance}checked="true"{/if} />
                                            ...
                                            <div class="row p-2 view-block {if $socials_error}hide{/if}">
                                                ...
                                                {foreach $files as $file}
                                                    ...
                                                    <li class="order-image-item ribbon-wrapper rounded-sm border {$item_class}">
                                                        <a class="image-popup-fit-width" href="javascript:void(0)" onclick="window.open('{$config->back_url}/files/users/{$file->name}')">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-lg-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"  id="status_{$file->id}" name="status[{$file->id}]" value="{$file->status}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        {if $order->contract->status==3}<br /><small>{$order->contract->close_date|date} {$order->contract->close_date|time}</small>{/if}
                                                                    </td>
                                                                </tr>
                                                                {/if}
                                                                {/foreach}
