...
<div>являющийся субъектом персональных данных в соответствии со статьями 9, 10 Федерального закона от 27 июля 2006 года
    №
    152-ФЗ
...
<div style="font-size: 9px"><u>Цель обработки персональных данных:</u><br><br>- обеспечение соблюдения требований
    ...
    последующего его исполнения<br>Обработка вышеуказанных персональных данных будет осуществляться путём смешанной
