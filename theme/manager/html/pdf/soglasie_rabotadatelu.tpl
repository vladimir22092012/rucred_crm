...
<div style="font-size: 9px" align="justify">являющийся субъектом персональных данных в соответствии со статьями 9, 10
    ...
    152-ФЗ
    «О персональных данных» настоящим подтверждаю, что даю своё согласие на предоставление Обществу с ограниченной
    ответственностью Микрокредитная компания «Русское кредитное общество» (ИНН
    9725055162)
