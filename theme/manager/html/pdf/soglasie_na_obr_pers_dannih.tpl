...
<div><br>
    ...
    115280, город Москва, улица Ленинская Слобода, дом 26, строение 28, помещение I, комната 290, тел. +7 (495)
    ...
    место и причина изменения в случае их изменения);<br>• число, месяц, год рождения;<br>
    • место рождения;<br>
    ...
    письменном виде.<br><br>Настоящим подтверждаю, что 0 не являюсь / 0 являюсь иностранным публичным должностным лицом,
    ...
    согласие, я действую по собственной воле и в своих интересах.<br><br>
    Данное согласие действует с момента предоставления в течение 5 (Пяти) лет. Данное согласие может быть отозвано в
